<a onclick="noty_activatePro(event, {{ $entry }})" class="btn btn-sm btn-link" href="#"
...
<script>
    function noty_activatePro(event, entry) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response == 'success') {
                                Swal.fire({
                                    title: "Succes!",
                                    text: "All subservices from this project are activated for " +
                                        hour
                                        .toString() + " Hours!",
                                    icon: "success"
                                });
